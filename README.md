...
<div style="display: flex; justify-content: center; align-items: center; width: 800px; gap: 50px; border: 2px solid red;">
  <img src="assets/push_swap.gif" style="width: 400px;">
